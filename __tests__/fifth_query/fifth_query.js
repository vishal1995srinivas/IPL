...
function fifth_query(throws) {
  ...
  if(throws[0].bowler == undefined || throws[0].total_runs == undefined)
  {
    return "No bowler details / total Runs";
  }
  else
  {
  for (match of throws) {
  ...
  return topMaidenBowlers;
}
}
/*fifth_query(nothrows);
fifth_query(throws);
fifth_query(nonmaidenthrows);*/
